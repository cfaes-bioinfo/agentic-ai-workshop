...
3. Load the STAR module with the most recent version of STAR
   and test whether you can use the program by running `STAR` ---
   in this case, without adding any options^[
   Unfortunately, not all programs have the same way to pull version information, and so on. 
   ]. 
