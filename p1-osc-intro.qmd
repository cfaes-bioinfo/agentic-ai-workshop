...
This part introduces high-performance computing 
...
- **By default, you will be placed in your Home directory when you --e.g.-- log in to OSC.**
  ...
  During this workshop, for example, you should be within `/fs/ess/PAS3454/` ---
...
![_The OnDemand file browser_ -- **TBA replace screenshot**](img/ondemand_files_PAS2880.png){fig-align="center" width="95%" fig-alt="A screenshot of the OSC OnDemand file browser." .lightbox}
