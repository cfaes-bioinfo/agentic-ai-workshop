...
(recall that Copilot also has chat functionality;
and this is similar to that of Claude Code, but here we'll focus on the latter).
...
### Features in the Claude Code prompt box

![The Claude Code prompt box.](/img/claude-prompt-box.png){fig-align="center" width="70%" .lightbox fig-alt="Screenshot of the Claude Code prompt box"}

Starting on the left side:

- The `+` icon allows you to add **context in the form of files**.
  In the context of in-editor chat, the files we want to are present ...
  ...
  - Mention `@workspace` and implicit context of all files in the workspace

  ![](/img/claude-context-add1.png){fig-align="center" width="70%" .lightbox fig-alt="Screenshot of the Claude Code prompt box, showing the 'Add context' button and the file selection window"}
...
- On the right-hand side is the **Permission Modes** indicator.
