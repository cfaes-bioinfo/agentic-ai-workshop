...
- **Encoder-only model (Google’s BERT) **\
  ...
  - DNABERT reads the entire DNA sequence and learns how different parts relate to each other
...
- **Decoder-only model (OpenAI GPT series)**\
  ...
  - **Self attention** - Predict the next token based on the previous tokens
  - Example - **ProGen**
