...
3. Fill out the form as follows:
   ...
   - **Account**: `PAS3454`
   - **Number of hours**: `2`
   - **Working Directory**:" `/fs/ess/PAS3454/user/<username>` (replace `<username>` with your actual user name)
...
(e.g. `/fs/ess/PAS3454/users/jelmer`).
...
to `/fs/ess/PAS3454/users/<user>` instead.
...
## TBA: Some file (`ls` etc) examples or as optional homework?